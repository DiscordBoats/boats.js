...
module.exports = class BoatsClient {
  ...
  */
  getBot(botid) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const res = await fetch(`https://discord.boats/api/${this.version}/bot/${botid}`).send();
  ...
  */
  getVoted(botid, userid) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const res = await fetch(`https://discord.boats/api/${this.version}/bot/${botid}/voted?id=${userid}`).send();
        const data = await res.json();
  ...
  */
  getUser(userid) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const res = await fetch(`https://discord.boats/api/${this.version}/user/${userid}`).send();
        const data = await res.json();
